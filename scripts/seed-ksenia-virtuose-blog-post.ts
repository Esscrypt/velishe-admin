...
const BODY = `Runway proof travels fast when the credit line is clear.

**Ksenia Lev** walked for **Tigerstrolling** during **VIRTUOSE 2026** in **Hong Kong** — a show moment that landed in **Vogue Hong Kong** and **Harper's Bazaar HK**. For Velishe Model Management, it is exactly the kind of international placement that compounds: designer credit, city credit, press credit, and a model who can hold a runway frame under show lights.

VIRTUOSE sits inside Hong Kong's fashion-week energy — HKFDA, Fashion Design HK, West K, Hong Kong Palace Museum — and Tigerstrolling's line reads sharp on the move. Ksenia's walk does the rest: pace, posture, and a face that editorial teams can place on a cover or in a campaign deck without explanation.

International runway is still how boutique agencies signal range. One strong Hong Kong week becomes the next casting brief.`;
